...
import { Section, Timeline, ExperienceItem, ExperienceContent, TimelineDot, ExperienceTitle, Company, Duration, Description } from "./Experience.styles";
        ...
        <Timeline>
          {experiences.map((exp, index) => (
            <div key={index} style={{ position: "relative" }}>
              <ExperienceItem isLeft={index % 2 === 0}>
